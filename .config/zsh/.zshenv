...
# Paths
export PATH=$PATH:$HOME/.local/bin:$XDG_DATA_HOME/go/bin:$XDG_DATA_HOME/nvim/mason/bin:$HOME/Applications
...
export BROWSER=firefox ; export BROWSERplus="tabbed -dcn tabbed-surf -r 2 surf -e '' www.google.com"
